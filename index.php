              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <img id="img-carousel" src="pictures/Full/Crates/Dos_Palmas.jpg" alt="Dos Palmas">
                  </div>

                  <div class="item">
                    <img id="img-carousel" src="pictures/Full/Crates/Mission_Play.jpg" alt="Mission Play">
                  </div>

                  <div class="item">
                    <img id="img-carousel" src="pictures/Full/Crates/Titus_Ranch.jpg" alt="Titus Ranch">
                  </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="col-lg-6">
                        <img class="img-responsive" style="float:right; border: 2px solid black;" src="pictures/Full/1404_Wilson.jpg" height="100%" width="100%">
                      </div>
                      <div class="col-lg-6">
                        <h3>
                          <p>
