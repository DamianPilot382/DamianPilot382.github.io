...
<html lang="en">
    ...
    <head>
        ...
        <title>San Marino Heritage | Roland Coate</title>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Roland Coate</h1>
                            <ol class="breadcrumb">
                                <li><a href="../index.php">Home</a></li>
                                <li class="active">Roland Coate</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img style="margin: 0 auto;" class="img-responsive" src="../pictures/Full/Architects/Roland_Coate.jpg" alt="">
                        </div>
