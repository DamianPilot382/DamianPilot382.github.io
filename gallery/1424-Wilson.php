...
<html lang="en">
    ...
    <head>
        ...
        <title>San Marino Heritage | 1424 Wilson Ave.</title>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">1424 Wilson Ave.</h1>
                            <ol class="breadcrumb">
                                <li><a href="../index.php">Home</a></li>
                                <li class="active">1424 Wilson Ave.</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <img class="img-responsive" src="../pictures/Full/1424_Wilson.jpg" alt="">
                        </div>

                        <div class="col-md-4">
                            <h3>1424 Wilson Ave.</h3>
