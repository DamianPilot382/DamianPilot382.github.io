...
<html lang="en">
    ...
    <head>
        ...
        <title>San Marino Heritage | Los Robles Ranch House</title>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Los Robles Ranch House</h1>
                            <ol class="breadcrumb">
                                <li><a href="../index.php">Home</a></li>
                                <li class="active">Los Robles Ranch House</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <img class="img-responsive" src="../pictures/Full/Los_Robles_Ranch_House.jpg" alt="">
                        </div>

                        <div class="col-md-4">
                            <h3>Los Robles Ranch House</h3>
