...
<html lang="en">
    ...
    <head>
        ...
        <title>San Marino Heritage | 1406 Wilson Ave. Demolition</title>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">1406 Wilson Ave. Demolition</h1>
                            <ol class="breadcrumb">
                                <li><a href="../index.php">Home</a></li>
                                <li class="active">1406 Wilson Ave. Demolition</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h3>1406 Wilson Ave. Demolition</h3>
