...
<html lang="en">
    ...
    <head>
        ...
        <title>San Marino Heritage | The Patton Memorial</title>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">The Patton Memorial</h1>
                            <ol class="breadcrumb">
                                <li><a href="../index.php">Home</a></li>
                                <li class="active">The Patton Memorial</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <img class="img-responsive" src="../pictures/Full/Patton_Memorial.jpg" alt="">
                        </div>

                        <div class="col-md-4">
                            <h3>The Patton Memorial</h3>
